...
const days: DayPlan[] = [
  ...
  { day: 3, date: "9月23日 · 周三", place: "Alcatraz Island", hotelId: "hotel-caza", events: [{ time: "08:30–09:00", label: "抵达 Pier 33 Alcatraz Landing" }, { time: "09:10–12:30", label: "Alcatraz Island / 往返轮渡" }, { time: "12:45–14:00", label: "Embarcadero 午餐 / 返回酒店" }], note: "只从官方运营方购票，并至少提前 30 分钟抵达 Pier 33；随身带水和简餐并遵守现场饮食区域规定" },
  { day: 4, date: "9月24日 · 周四", place: "Napa Valley → Sacramento", hotelId: "holiday-inn-sacramento", events: [{ time: "07:45–08:30", label: "前往 SFO 取车 / 加油 / 检查证件" }, { time: "08:30–09:58", label: "SFO → Napa Valley" }, { time: "10:00–11:30", label: "Domaine Carneros（预约品鉴）" }, { time: "11:50–13:05", label: "Oxbow Public Market / 午餐" }, { time: "13:05–14:15", label: "Napa Valley → Sacramento" }, { time: "14:15–15:00", label: "California State Capitol Park" }, { time: "15:00–16:00", label: "Holiday Inn Sacramento Downtown – Arena check-in" }], note: "驾驶者不饮酒；酒店停车为收费项目，抵达前确认订单是否包含停车", drive: "约 2 小时 45 分" },
  { day: 5, date: "9月25日 · 周五", place: "Sacramento → Lake Tahoe", hotelId: "alder-inn", events: [{ time: "09:00–10:30", label: "Old Sacramento Waterfront" }, { time: "10:45–12:00", label: "Joe’s Crab Shack · Lunch" }, { time: "12:15–12:45", label: "Trader Joe’s · 水和野餐补给" }, { time: "12:45–14:45", label: "Sacramento → Lake Tahoe" }, { time: "14:45–16:15", label: "湖边休息 / The Alder Inn check-in" }], note: "最新版表格增加 Trader Joe’s 补给；山路驾驶前加满油并下载离线地图", drive: "约 2 小时 15 分 + 采购" },
  ...
  { day: 8, date: "9月28日 · 周一", place: "Lake Tahoe → Yosemite", hotelId: "yosemite-cedar-lodge", events: [{ time: "08:00–11:00", label: "South Lake Tahoe → Tioga Pass Entrance" }, { time: "11:00–11:20", label: "Tioga Pass / 路况确认" }, { time: "12:05–12:35", label: "Olmsted Point" }, { time: "12:35–15:05", label: "经 Yosemite Valley 前往 El Portal" }, { time: "15:05–16:05", label: "Yosemite Cedar Lodge check-in / 休息" }], note: "2小时40分只接近东侧山口；到 Yosemite Cedar Lodge 请按约 6 小时，并确认 Tioga Road 开放", drive: "约 6 小时 15 分" },
  { day: 9, date: "9月29日 · 周二", place: "Yosemite Valley Highlights", hotelId: "yosemite-cedar-lodge", events: [{ time: "07:20–08:00", label: "Yosemite Cedar Lodge → Tunnel View" }, { time: "08:00–08:30", label: "Tunnel View" }, { time: "08:40–09:40", label: "Bridalveil Fall" }, { time: "09:50–10:15", label: "Valley View" }, { time: "10:20–10:55", label: "El Capitan Meadow" }, { time: "13:00–14:15", label: "Cook’s Meadow Loop" }, { time: "14:25–15:25", label: "Lower Yosemite Fall / Sentinel Bridge 备选" }], note: "9月底 Yosemite Falls 可能接近断流；当天优先看花岗岩地貌与草甸", drive: "约 2 小时 10 分（含返回酒店）" },
  { day: 10, date: "9月30日 · 周三", place: "Glacier Point & High Country Views", hotelId: "yosemite-cedar-lodge", events: [{ time: "06:45–08:20", label: "Yosemite Cedar Lodge → Washburn Point" }, { time: "08:20–08:45", label: "Washburn Point" }, { time: "08:55–09:55", label: "Glacier Point" }, { time: "10:15–12:15", label: "Sentinel Dome Trail" }, { time: "12:15–13:00", label: "野餐 / 休息" }, { time: "13:15–15:15", label: "Taft Point（体力允许时）" }, { time: "15:15–17:00", label: "返回 Yosemite Cedar Lodge" }], note: "以 Glacier Point 和 Sentinel Dome 为核心；Cedar Lodge 稍远，因此提前 15 分钟出发，Taft Point 仍是可删减项", drive: "驾车约 3 小时 30 分 + 徒步约 4 小时" },
  { day: 11, date: "10月1日 · 周四", place: "Yosemite → Sunnyvale", hotelId: "best-western-silicon-valley", events: [{ time: "08:00–09:00", label: "早餐 / 退房" }, { time: "09:00–13:15", label: "Yosemite Cedar Lodge → Sunnyvale（含休息）" }, { time: "13:15–15:00", label: "午餐 / 酒店寄存行李" }, { time: "15:00–16:00", label: "Best Western Silicon Valley Inn check-in" }, { time: "16:20–17:20", label: "Municipal Rose Garden" }, { time: "17:30–19:15", label: "Santana Row / 晚餐" }], note: "住宿已按最终表格改到 Sunnyvale；长途驾驶后若晚到，可直接取消玫瑰园", drive: "约 3 小时 45 分 + 休息与市区短途" },
  { day: 12, date: "10月2日 · 周五", place: "Great Mall → Winchester Mystery House", hotelId: "best-western-silicon-valley", events: [{ time: "09:40–10:00", label: "Sunnyvale → Great Mall" }, { time: "10:00–13:30", label: "Great Mall / Outlet Shopping" }, { time: "13:30–14:15", label: "前往 Winchester Mystery House / 简餐" }, { time: "14:15–16:15", label: "Winchester Mystery House" }, { time: "17:00–19:00", label: "San Pedro Square Market / 晚餐" }], note: "表格估算酒店到 Great Mall 约 20 分钟；建议先预约下午场，再据此调整购物时长", drive: "约 1 小时 10 分" },
  { day: 13, date: "10月3日 · 周六", place: "Lemos Farm", hotelId: "best-western-silicon-valley", events: [{ time: "09:00–09:50", label: "Sunnyvale → Half Moon Bay" }, { time: "10:00–12:30", label: "Lemos Farm" }, { time: "12:45–14:00", label: "Half Moon Bay 午餐" }, { time: "14:00–15:00", label: "返回 Sunnyvale" }], note: "周六通常 10:00–17:00；秋季周末建议提前购票", drive: "约 1 小时 50 分往返" },
  { day: 14, date: "10月4日 · 周日", place: "Sunnyvale → SFO → 北京", hotelId: "best-western-silicon-valley", events: [{ time: "06:30–07:30", label: "酒店退房 / 前往 SFO / 还车" }, { time: "07:30–10:35", label: "国际航班值机 / 安检 / 登机" }, { time: "10:35–15:25 +1", label: "UA888 · San Francisco → Beijing" }], note: "表格预计酒店到 SFO 约 41 分钟；仍建议起飞前约 3 小时抵达机场", drive: "约 41 分钟 + 还车" },
];
    ...
    <main>
      ...
      <section className="stays-section" id="stays">
        <div className="stays-intro">
          ...
          <h2>从海湾，到山谷</h2>
          <p>住宿已按最新选择同步：San Francisco 三晚、Sacramento 一晚、The Alder Inn 三晚、Yosemite Cedar Lodge 三晚，最后在 Best Western Silicon Valley Inn 连住三晚。未提供订单号的酒店以推荐方案显示。</p>
        </div>
      ...
      <footer>
        ...
        <p>路线依据《Trip planning_Final.xlsx》整理；住宿以已确认选择和最新版表格为准，开放时间、驾驶时长与航班以出发前官方信息和实时导航为准。封面摄影来自 Unsplash：
