...
const days: DayPlan[] = [
  ...
  { day: 11, date: "10月1日 · 周四", place: "Yosemite → San Jose", hotelId: "hyatt-san-jose", events: [{ time: "08:00–09:00", label: "早餐 / 退房" }, { time: "09:00–13:15", label: "Yosemite Cedar Lodge → San Jose（含休息）" }, { time: "13:15–15:00", label: "午餐 / 酒店寄存行李" }, { time: "15:00–16:00", label: "酒店入住" }, { time: "16:15–17:15", label: "Municipal Rose Garden" }, { time: "17:30–19:15", label: "Santana Row / 晚餐" }], note: "长途驾驶日只保留两个轻松市区停留；若晚到，直接取消玫瑰园", drive: "约 3 小时 45 分 + 休息与市区短途" },
    ...
    <main>
      ...
      <section className="stays-section" id="stays">
        <div className="stays-intro">
          ...
          <h2>从海湾，到山谷</h2>
          <p>住宿已按最新选择同步：San Francisco 三晚、Sacramento 一晚、The Alder Inn 三晚、Yosemite Cedar Lodge 三晚，最后在 San Jose 连住三晚。未提供订单号的酒店以推荐方案显示。</p>
        </div>
