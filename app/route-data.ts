...
export const optimizedDays: OptimizedDay[] = [
  ...
  },
  {
    ...
    points: [
      ...
      { id: "d4-nelder", day: 4, order: 3, cn: "内尔德红杉林", name: "Nelder Grove Interpretive Area", coordinates: [-119.5849, 37.4245], travelMode: "驾车", travelMinutes: 145, travelLabel: "Modesto → Nelder Grove", visitMinutes: 75, note: "这是较大的绕行项；仅在 USFS 确认道路开放且当天按时出发时保留，否则直接前往 Mariposa 酒店。" },
      { id: "d4-way-station", day: 4, order: 4, cn: "Mariposa 酒店入住", name: "Best Western Plus Yosemite Way Station Motel", coordinates: [-119.9686, 37.4863], travelMode: "驾车", travelMinutes: 75, travelLabel: "Nelder Grove → Mariposa", visitMinutes: 60, note: "16:00 后入住；步行前往 Downtown Mariposa 用晚餐。" },
    ],
  },
  {
    day: 5,
    ...
    points: [
      ...
      { id: "d5-bridalveil", day: 5, order: 2, cn: "新娘面纱瀑布", name: "Bridalveil Fall", coordinates: [-119.6505, 37.7159], travelMode: "驾车", travelMinutes: 10, visitMinutes: 60 },
      ...
      { id: "d5-sentinel", day: 5, order: 4, cn: "哨兵桥", name: "Sentinel Bridge", coordinates: [-119.5899, 37.7373], travelMode: "驾车 / 接驳车", travelMinutes: 15, visitMinutes: 30 },
      { id: "d5-lower-fall", day: 5, order: 5, cn: "下优胜美地瀑布", name: "Lower Yosemite Fall", coordinates: [-119.5965, 37.749], travelMode: "步行 / 接驳车", travelMinutes: 15, visitMinutes: 60, note: "9 月底水量可能很低；若接近断流，把时间留给草甸和 Sentinel Bridge。" },
      { id: "d5-cooks", day: 5, order: 6, cn: "库克草甸环线", name: "Cook’s Meadow Loop", coordinates: [-119.5911, 37.7447], travelMode: "步行", travelMinutes: 10, visitMinutes: 75, note: "全天自带水和简餐，日落前返回 Mariposa。" },
    ],
  },
  {
    day: 6,
    ...
    points: [
      ...
      { id: "d6-taft", day: 6, order: 4, cn: "塔夫脱点", name: "Taft Point", coordinates: [-119.6046, 37.7129], travelMode: "徒步", travelMinutes: 45, visitMinutes: 75, note: "体力和天气允许时再走；疲劳时可跳过。" },
    ],
  },
  {
    day: 7,
    ...
    hotelId: "alder-inn",
    points: [
      { id: "d7-alder", day: 7, order: 1, cn: "南太浩湖酒店", name: "The Alder Inn / Hotel Check-in", coordinates: [-119.9562, 38.9464], travelMode: "驾车", travelMinutes: 239, travelLabel: "Mariposa → South Lake Tahoe", visitMinutes: 60, note: "表格估算 3 小时 59 分；实际山路和休息可能更久，16:00 后入住。" },
      { id: "d7-regan", day: 7, order: 2, cn: "Regan 纪念城市海滩", name: "Thomas F. Regan Memorial City Beach", coordinates: [-119.9777, 38.9492], travelMode: "驾车", travelMinutes: 6, visitMinutes: 75, note: "长途驾驶后的轻松湖边散步。" },
    ],
  },
  {
    day: 8,
    ...
    hotelId: "alder-inn",
    points: [
      { id: "d8-gather", day: 8, order: 1, cn: "Gather 早餐", name: "Gather Botanical Café", coordinates: [-119.9838, 38.9481], travelMode: "驾车 / 步行", travelMinutes: 8, travelLabel: "从酒店出发", visitMinutes: 60 },
      { id: "d8-emerald", day: 8, order: 2, cn: "翡翠湾", name: "Emerald Bay State Park", coordinates: [-120.1015, 38.954], travelMode: "驾车", travelMinutes: 35, visitMinutes: 90, note: "上午先到热门停车点；提前买好在湖边吃的食物。" },
  ...
  },
  {
    ...
    points: [
      ...
      { id: "d11-sunnyvale", day: 11, order: 3, cn: "Sunnyvale 酒店入住", name: "Best Western Silicon Valley Inn / Check-in", coordinates: [-122.0295, 37.392], travelMode: "驾车", travelMinutes: 120, travelLabel: "Napa → Sunnyvale", visitMinutes: 60, note: "15:00 后入住；长途驾驶后晚上不再安排正式景点。" },
    ],
  },
  {
    day: 12,
  ...
  },
  {
    ...
    points: [
      ...
      { id: "d13-pastorino", day: 13, order: 2, cn: "Pastorino 南瓜农场", name: "Pastorino Farms", coordinates: [-122.4208, 37.4709], travelMode: "驾车", travelMinutes: 5, visitMinutes: 60, note: "与 Lemos Farm 二选一即可；网页保留两处，方便按票务和兴趣决定。" },
  ...
  },
  {
    ...
    hotelId: "best-western-silicon-valley",
    points: [
      { id: "d14-sfo", day: 14, order: 1, cn: "旧金山国际机场", name: "San Francisco International Airport", coordinates: [-122.379, 37.6213], travelMode: "驾车", travelMinutes: 41, travelLabel: "从 Sunnyvale 酒店出发", visitMinutes: 180, note: "UA888 10:35 起飞；建议 06:30 左右离店，为路况、还车和国际航班值机留缓冲。" },
    ],
  },
];
...
export const routePointTimes: Record<string, string> = {
  ...
  "d4-nelder": "13:25–14:40",
  "d4-way-station": "15:55–17:00",
  "d5-tunnel": "08:05–08:35",
  "d5-bridalveil": "08:45–09:45",
  "d5-el-capitan": "09:55–10:30",
  "d5-sentinel": "10:45–11:15",
  "d5-lower-fall": "11:30–12:30",
  "d5-cooks": "13:00–14:15",
  "d6-washburn": "08:30–08:55",
  "d6-glacier": "09:05–10:05",
  "d6-sentinel": "10:25–12:25",
  "d6-taft": "13:15–15:15",
  "d7-alder": "13:00–14:00",
  "d7-regan": "14:20–15:35",
  "d8-gather": "08:00–09:00",
  "d8-emerald": "09:35–11:05",
  "d8-tallac": "11:25–12:40",
  "d8-pope": "13:00–14:30",
  ...
  "d11-sunnyvale": "15:25–16:25",
  "d12-great-mall": "10:00–14:00",
  "d13-lemos": "10:00–12:00",
  "d13-pastorino": "12:10–13:10",
  "d13-hmb": "13:20–15:20",
  "d14-sfo": "07:30–10:35",
};
