...
export const optimizedDays: OptimizedDay[] = [
  ...
  },
  {
    ...
    points: [
      ...
      { id: "d8-lodge", day: 8, order: 3, cn: "优胜美地雪松旅馆", name: "Yosemite Cedar Lodge", coordinates: [-119.8525, 37.6601], travelMode: "驾车", travelMinutes: 150, travelLabel: "经 Yosemite Valley 前往 El Portal", visitMinutes: 60, note: "Lake Tahoe 到 Yosemite Cedar Lodge 经 Tioga Road 全程按约 6 小时净驾驶规划，并在出发前确认 Tioga Road 状态。" },
    ],
  },
  {
    day: 9,
    ...
    hotelId: "yosemite-cedar-lodge",
    points: [
      { id: "d9-tunnel", day: 9, order: 1, cn: "隧道观景台", name: "Tunnel View", coordinates: [-119.6778, 37.7158], travelMode: "驾车", travelMinutes: 40, travelLabel: "从 Yosemite Cedar Lodge 出发", visitMinutes: 30 },
  ...
  },
  {
    ...
    hotelId: "yosemite-cedar-lodge",
    points: [
      { id: "d10-washburn", day: 10, order: 1, cn: "沃什伯恩观景台", name: "Washburn Point", coordinates: [-119.5729, 37.7206], travelMode: "驾车", travelMinutes: 95, travelLabel: "从 Yosemite Cedar Lodge 出发", visitMinutes: 25, note: "Glacier Point 前的顺路短停，可先看 Half Dome 与瀑布群的全景。" },
