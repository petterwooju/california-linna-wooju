globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CaREJhVJ.js","assets/leaflet-src-BbiSgxSs.js","assets/layout-segment-context-BbYRgKqx.js"];
...
function getDraftSecret() {
	return "eba503af-eb3d-4f46-93bc-018e0fdc2b95";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "7d047589-2129-48d5-8ce8-10e98aa64371";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "7d047589-2129-48d5-8ce8-10e98aa64371") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "7d047589-2129-48d5-8ce8-10e98aa64371",
		rootBoundaryId
	});
}
/**
...
async function generateMetadata() {
	...
	return {
		...
		openGraph: {
			...
			type: "website",
			url: `${incomingHeaders.get("x-forwarded-proto") ?? (host.includes("localhost") ? "http" : "https")}://${host}`,
...
var __publicFiles = new Set([
	"/favicon.png",
	"/og.png",
	"/places/death-valley.jpg",
	"/places/los-angeles.jpg",
	"/places/san-francisco.jpg",
	"/places/sequoia.jpg",
	"/places/yosemite.jpg"
]);
